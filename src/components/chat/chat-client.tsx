...
export function ChatClient() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-5 lg:gap-6">
      <div className="shrink-0 flex flex-col gap-4 rounded-[2rem] border border-black/5 bg-white/60 p-5 shadow-sm backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between">
